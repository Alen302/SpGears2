...
//      println(formatTestCases)
      io.pixelsIn.setDriver(clockDomain, Seq(testCases, frameStartIns, rowEndIns): _*)
      io.pixelsIn.setMonitor(clockDomain, Seq(getTestCasesIns, getFrameStartIns, getRowEndIns): _*)
      io.pixelsOut.setMonitor(clockDomain, Seq(pixelOuts, frameStartOuts, rowEndOuts, inpValidOuts): _*)
      io.pixelsOut.setRandomReady(clockDomain)
