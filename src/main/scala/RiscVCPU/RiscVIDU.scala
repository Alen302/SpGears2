...
import RiscVCPU.insType.{BType, IType, JType, RType, SType, UType, insType}
import RiscVCPU.opType.{ASrl, Add, And, Div, EBreak, Eq, Ge, Jump, Load, Lt, Mul, Neq, Or, Rem, Sll, Slt, Srl, Store, Sub, Ua, Ul, Xor, opType}
