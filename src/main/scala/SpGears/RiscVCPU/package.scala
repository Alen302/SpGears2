...
import SpGears.RiscVCPU.insType.{insType, RType, SType, BType, IType, UType, JType}
import SpGears.RiscVCPU.opType.{opType, Add, Sub, Mul, Div, Sll, Srl, Load, Store, Slt, ASrl, Ul, Ua, Xor, Or, And, Jump, Eq, Neq, Lt, Ge, Rem, EBreak}
