package CompArith.Divider

import spinal.lib._
import CompArith.Adders._
import spinal.core._
import scala.collection._
import spinal.core.sim._

case class NonResDivider(config: DividerConfig) extends Component {
  val io = new Bundle {
...
object TestNonRestoringDivider extends App {
  SimConfig.withWave.allOptimisation.compile(NonResDivider(DividerConfig(true, 4)))
    .doSim { dut =>
