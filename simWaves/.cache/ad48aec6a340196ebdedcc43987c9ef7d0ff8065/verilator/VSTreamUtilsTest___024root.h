...
VL_MODULE(VSTreamUtilsTest___024root) {
  public:
    ...
    CData/*4:0*/ STreamUtilsTest__DOT__dataIn_rData_a;
    CData/*5:0*/ STreamUtilsTest__DOT__dataIn_rData_b;
    CData/*0:0*/ STreamUtilsTest__DOT__dataIn_s2mPipe_rValid;
    CData/*4:0*/ STreamUtilsTest__DOT__dataIn_s2mPipe_rData_a;
    CData/*5:0*/ STreamUtilsTest__DOT__dataIn_s2mPipe_rData_b;
