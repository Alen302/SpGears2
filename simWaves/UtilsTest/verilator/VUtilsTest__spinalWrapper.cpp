...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new CDataSignalAccess( top.dataIn_ready );
      signalAccess[2] = new CDataSignalAccess( top.dataIn_payload_a );
      signalAccess[3] = new CDataSignalAccess( top.dataIn_payload_b );
      signalAccess[4] = new CDataSignalAccess( top.baseIn );
      signalAccess[5] = new CDataSignalAccess( top.dataOut_valid );
      signalAccess[6] = new CDataSignalAccess( top.dataOut_ready );
      signalAccess[7] = new CDataSignalAccess( top.dataOut_payload_a );
      signalAccess[8] = new CDataSignalAccess( top.dataOut_payload_b );
      signalAccess[9] = new CDataSignalAccess( top.baseOut );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/SpGears/./simWaves/UtilsTest/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/SpGears/./simWaves/UtilsTest/") + name + ".dat").c_str());
      #endif
    }
