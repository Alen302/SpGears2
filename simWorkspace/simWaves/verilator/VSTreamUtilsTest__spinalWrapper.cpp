...
#endif
#include "VSTreamUtilsTest__Syms.h"
...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new CDataSignalAccess( top.dataIn_payload );
      signalAccess[3] = new CDataSignalAccess( top.dataOut_valid );
      signalAccess[4] = new CDataSignalAccess( top.dataOut_ready );
      signalAccess[5] = new CDataSignalAccess( top.dataOut_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/SpGears/./simWorkspace/./simWaves/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/SpGears/./simWorkspace/./simWaves/") + name + ".dat").c_str());
      #endif
    }
