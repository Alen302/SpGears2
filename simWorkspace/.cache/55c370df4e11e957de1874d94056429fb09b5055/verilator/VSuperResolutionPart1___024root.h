...
VL_MODULE(VSuperResolutionPart1___024root) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ SuperResolutionPart1__DOT___zz_io_outputs_1_ready;
        CData/*7:0*/ SuperResolutionPart1__DOT___zz_resultStage_resultStream_payload;
        CData/*0:0*/ SuperResolutionPart1__DOT___zz_resultStage_resultStream_valid;
        CData/*7:0*/ SuperResolutionPart1__DOT___zz_resultStage_resultStream_payload_1;
