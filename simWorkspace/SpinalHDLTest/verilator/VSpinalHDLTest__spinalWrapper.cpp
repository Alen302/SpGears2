...
#endif
#include "VSpinalHDLTest__Syms.h"
...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_in1 );
      signalAccess[1] = new CDataSignalAccess( top.io_in2 );
      signalAccess[2] = new CDataSignalAccess( top.io_out1 );
      signalAccess[3] = new CDataSignalAccess( top.io_out2 );
      signalAccess[4] = new CDataSignalAccess( top.io_out3 );
      signalAccess[5] = new CDataSignalAccess( top.io_out4 );
      signalAccess[6] = new CDataSignalAccess( top.io_out5 );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/LicioLib/./simWorkspace/SpinalHDLTest/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/LicioLib/./simWorkspace/SpinalHDLTest/") + name + ".dat").c_str());
      #endif
    }
