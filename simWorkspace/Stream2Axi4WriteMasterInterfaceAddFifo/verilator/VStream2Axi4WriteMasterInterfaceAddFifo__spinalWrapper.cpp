...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/LicioLib/./simWorkspace/Stream2Axi4WriteMasterInterfaceAddFifo/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/LicioLib/./simWorkspace/Stream2Axi4WriteMasterInterfaceAddFifo/") + name + ".dat").c_str());
      #endif
    }
