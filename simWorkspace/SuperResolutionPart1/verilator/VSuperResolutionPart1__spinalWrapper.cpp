...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.pixelsIn_valid );
      signalAccess[1] = new CDataSignalAccess( top.pixelsIn_ready );
      signalAccess[2] = new CDataSignalAccess( top.pixelsIn_payload_pixel );
      signalAccess[3] = new CDataSignalAccess( top.pixelsIn_payload_frameStart );
      signalAccess[4] = new CDataSignalAccess( top.pixelsIn_payload_rowEnd );
      signalAccess[5] = new CDataSignalAccess( top.StartIn );
      signalAccess[6] = new CDataSignalAccess( top.inpTwoDoneIn );
      signalAccess[7] = new CDataSignalAccess( top.inpThreeDoneIn );
      signalAccess[8] = new CDataSignalAccess( top.pixelsOut_valid );
      signalAccess[9] = new CDataSignalAccess( top.pixelsOut_ready );
      signalAccess[10] = new CDataSignalAccess( top.pixelsOut_payload_pixel );
      signalAccess[11] = new CDataSignalAccess( top.pixelsOut_payload_frameStart );
      signalAccess[12] = new CDataSignalAccess( top.pixelsOut_payload_rowEnd );
      signalAccess[13] = new CDataSignalAccess( top.pixelsOut_payload_inpValid );
      signalAccess[14] = new CDataSignalAccess( top.startOut );
      signalAccess[15] = new CDataSignalAccess( top.inpDoneOut );
      signalAccess[16] = new CDataSignalAccess( top.thresholdIn );
      signalAccess[17] = new CDataSignalAccess( top.widthIn );
      signalAccess[18] = new CDataSignalAccess( top.heightIn );
      signalAccess[19] = new CDataSignalAccess( top.clk );
      signalAccess[20] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/SpGears/./simWorkspace/SuperResolutionPart1/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/SpGears/./simWorkspace/SuperResolutionPart1/") + name + ".dat").c_str());
      #endif
    }
